...
class Customer:
    ...
    def statement(self):
        ...
        for rental in self.rentals:
            amount = self.rental_price(rental)
            # award renter points
    ...
    def rental_price(self, rental):
        ...
        if rental.get_movie().get_price_code() == Movie.REGULAR:
            ...
            if rental.get_days_rented() > 2:
                result += 1.5 * (rental.get_days_rented() - 2)
